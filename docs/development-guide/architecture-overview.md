...
- [src/chattool/client/main.py](/home/zhihong/workspace/ChatTool/src/chattool/client/main.py) 统一聚合 `env`、`dns`、`serve`、`network`、`mcp`、`lark`、`image`、`gh`、`browser`、`zulip`、`skill`、`setup`、`cc`、`docker` 等子命令。
- [pyproject.toml](/home/zhihong/workspace/ChatTool/pyproject.toml) 直接暴露 `chattool`、`chatenv`、`chatskill` 三类入口。
- `cli-tests/` 采用 doc-first 机制，说明 CLI 被视为一等公民，而不是实现之后顺带补一个壳。
...
这种边界在 [docs/development-guide/directory-responsibilities.md](/home/zhihong/workspace/ChatTool/docs/development-guide/directory-responsibilities.md) 里已经被明确写成规则。它的优势是：
...
这条路线在 [skills/practice-make-perfact/SKILL.zh.md](/home/zhihong/workspace/ChatTool/skills/practice-make-perfact/SKILL.zh.md) 和 [docs/development-guide/task-driven-iteration.md](/home/zhihong/workspace/ChatTool/docs/development-guide/task-driven-iteration.md) 中都已经明确：
...
- [src/chattool/config/cli.py](/home/zhihong/workspace/ChatTool/src/chattool/config/cli.py)
...
- [src/chattool/llm](/home/zhihong/workspace/ChatTool/src/chattool/llm)
...
- [src/chattool/tools/dns](/home/zhihong/workspace/ChatTool/src/chattool/tools/dns)
- [src/chattool/tools/lark](/home/zhihong/workspace/ChatTool/src/chattool/tools/lark)
- [src/chattool/tools/image](/home/zhihong/workspace/ChatTool/src/chattool/tools/image)
- [src/chattool/tools/network](/home/zhihong/workspace/ChatTool/src/chattool/tools/network)
- [src/chattool/tools/github](/home/zhihong/workspace/ChatTool/src/chattool/tools/github)
- [src/chattool/tools/zulip](/home/zhihong/workspace/ChatTool/src/chattool/tools/zulip)
- [src/chattool/tools/browser](/home/zhihong/workspace/ChatTool/src/chattool/tools/browser)
...
- [src/chattool/client/main.py](/home/zhihong/workspace/ChatTool/src/chattool/client/main.py)
...
- [src/chattool/mcp](/home/zhihong/workspace/ChatTool/src/chattool/mcp)
...
- [src/chattool/serve](/home/zhihong/workspace/ChatTool/src/chattool/serve)
...
- [src/chattool/setup](/home/zhihong/workspace/ChatTool/src/chattool/setup)
- [src/chattool/docker](/home/zhihong/workspace/ChatTool/src/chattool/docker)
...
- [src/chattool/skills](/home/zhihong/workspace/ChatTool/src/chattool/skills)
- [skills/practice-make-perfact](/home/zhihong/workspace/ChatTool/skills/practice-make-perfact)
...
- `src/` 中的正式能力实现
- `tests/` 中的常规测试
- `cli-tests/` 中围绕 CLI 行为的 doc-first 测试设计
...
5. 同步补 `tests/`、`cli-tests/`、`docs/`、`mkdocs.yml`。
