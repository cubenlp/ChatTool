...
def test_chattool_release_version_bump():
    ...
    dev_index = (repo_root / "docs/development-guide/index.md").read_text(encoding="utf-8")
    task_iter = (repo_root / "docs/development-guide/task-driven-iteration.md").read_text(encoding="utf-8")
