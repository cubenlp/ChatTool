...
def test_chattool_skill_practice_make_perfact_reference():
    ...
    skill_en = (repo_root / "skills/practice-make-perfact/SKILL.md").read_text(encoding="utf-8")
    skill_zh = (repo_root / "skills/practice-make-perfact/SKILL.zh.md").read_text(encoding="utf-8")
    reference = (
