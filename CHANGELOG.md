...
- [2026-05-06] ChatTool 本地迁移到外部 `chatstyle` runtime：删除 `chattool.chatstyle` 本地风格层，`chattool.interaction` 只保留 ChatTool 命令侧 adapter，prompt、choice、output、mask、flow 和 command schema 的通用实现由独立 ChatStyle 项目承载。
