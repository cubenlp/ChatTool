...
| Playground | `chattool setup playground` | Create a ChatTool-centered collaboration workspace with Chinese templates by default, plus optional `--language en` for English scaffolds |
