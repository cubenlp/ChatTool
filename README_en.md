...
| Playground | `chattool setup playground` | Create a ChatTool-centered collaboration workspace with Chinese templates by default, `ChatTool/`, `reports/`, `playgrounds/`, and `knowledge/skills/`; supports `--language en` |
