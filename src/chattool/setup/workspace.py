...
def _render_agents_md(
    ...
    if language == "en":
        return (
            ...
            "- When work belongs to a long-running series, group it as a task set under `reports/task-sets/<set-name>/`.\n"
            ...
            "| Human-facing task-set overview | `reports/task-sets/<set-name>/TASKSET.md` and `reports/task-sets/<set-name>/progress.md` |\n"
    ...
    return (
        ...
        "- 如果是一组围绕同一目标持续推进的大任务，改用任务集模式，放在 `reports/task-sets/<set-name>/`。\n"
        ...
        "| 给人的任务集总览 | `reports/task-sets/<set-name>/TASKSET.md` 和 `reports/task-sets/<set-name>/progress.md` |\n"
