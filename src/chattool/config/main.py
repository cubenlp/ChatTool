...
class FeishuConfig(BaseEnvConfig):
    ...
    FEISHU_DEFAULT_RECEIVER_ID = EnvField("FEISHU_DEFAULT_RECEIVER_ID", desc="Default receive_id for `chattool lark send` (optional)")
    FEISHU_TEST_USER_ID = EnvField("FEISHU_TEST_USER_ID", desc="Feishu test user ID for real `@pytest.mark.lark` tests")
    FEISHU_TEST_USER_ID_TYPE = EnvField("FEISHU_TEST_USER_ID_TYPE", default="user_id", desc="ID type for FEISHU_TEST_USER_ID (default: user_id)")
